  ...
  return _c("fragment", [
      ...
      [
        _c("div", { staticClass: "home-view" }, [
            ...
            _c("div", { staticClass: "home-header-info" }, [
              _c(
                ...
                [
                  ...
                  _c("span", [
                    _vm._v(
                      _vm._s(_vm.author.lname) + " " + _vm._s(_vm.author.fname)
                    )
                  ])
                ]
              ),
          ...
          _c("div", { staticClass: "home-content" }, [
            _c("div", { staticClass: "home-content-wrapper" }, [
              _c(
                "div",
                {
                  staticClass: "home-write-post",
                  on: { click: _vm.clickNewPost }
                },
                [
                  _c("div", { staticClass: "circle-icon add-icon" }, [
                    _vm._v("+")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "write-post-btn" }, [
                    _vm._v("Написать пост")
                  ])
                ]
              ),
              _vm._v(" "),
              _c(
                "div",
                {
                  staticClass: "home-drafts",
                  on: { click: _vm.openDraftList }
                },
                [
                  _c("div", { staticClass: "circle-icon drafts-count" }, [
                    _vm._v(
                      "\n              " +
                        _vm._s(
                          _vm.isFetchingDrafts ? null : _vm.drafts.length
                        ) +
                        "\n            "
                    )
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "drafts-btn" }, [
                    _vm._v("Ваши черновики")
                  ])
                ]
              ),
              _vm._v(" "),
              _c(
                ...
                [
                  ...
                  _vm._l(_vm.posts, function(post, postIndex) {
                    return _c(
                      "div",
                      { key: postIndex, staticClass: "post-item" },
                      [
    ...
    _c(
      "div",
      {
        ...
        staticClass: "draft-editor-wrapper"
      },
      [
        _c("div", { staticClass: "draft-editor" }, [
          _c("div", { staticClass: "draft-editor-header" }, [
            _c(
              "div",
              {
                staticClass: "circle-icon close-icon",
                on: { click: _vm.closeDraftEditor }
              },
              [_vm._v("x")]
            )
          ]),
          ...
          _c(
            "div",
            { key: _vm.editor.mode, staticClass: "draft-editor-footer" },
            [
              !_vm.editor.mode || _vm.editor.mode === "new"
                ? _c("div", { staticClass: "draft-btns" }, [
                    _c(
                      "div",
                      {
                        staticClass: "draft-editor-save-draft-btn",
                        on: { click: _vm.writeDraft }
                      },
                      [
                        _vm._v(
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "draft-editor-save-post-btn",
                        on: { click: _vm.writePost }
                      },
                      [_vm._v("\n            Опубликовать\n          ")]
                    )
                  ])
                : _vm.editor.mode === "edit"
                ? _c("div", { staticClass: "draft-btns" }, [
                    _c(
                      "div",
                      {
                        staticClass: "draft-editor-edit-draft-btn",
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "draft-editor-publish-post-btn",
                        on: { click: _vm.publishDraft }
                      },
                      [
                        _vm._v(
    ...
    _c(
      "div",
      {
        ...
        staticClass: "draft-list-wrapper"
      },
      [
        _c("div", { staticClass: "draft-list" }, [
          _c("div", { staticClass: "draft-list-header" }, [
            _c(
              "div",
              {
                staticClass: "circle-icon close-icon",
                on: { click: _vm.closeDraftList }
              },
              [_vm._v("x")]
            )
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "drafts-list-title" }, [
            _c("div", { staticClass: "circle-icon drafts-count" }, [
              _vm._v(
                "\n        " +
                  _vm._s(_vm.isFetchingDrafts ? null : _vm.drafts.length) +
                  "\n      "
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "drafts-btn" }, [_vm._v("Ваши черновики")])
          ]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "draft-list-scroller" },
            _vm._l(_vm.drafts, function(draft, draftIndex) {
              return _c(
                "div",
                {
                  key: draftIndex,
                ...
                [
                  ...
                  _c("div", { staticClass: "post-item-footer" }, [
                    _c(
                      "div",
                      { staticClass: "post-tags-list" },
                      _vm._l(draft.tags, function(tag, tagIndex) {
                        return _c(
                          "div",
                          { key: tagIndex, staticClass: "tag-item" },
                          [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "post-info" }, [
                      _c("div", { staticClass: "draft-note" }, [
                        _c("em", [_vm._v("Черновик")])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "post-item-updated-at" }, [
                        _vm._v(
                      ...
                      _c("div", { staticClass: "post-item-author" }, [
                        _vm._v(
                          "\n              " +
                            _vm._s(draft.author.lname) +
                            " " +
                            _vm._s(draft.author.fname) +
                            "\n            "
                        )
                      ])
                    ])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_views_Home_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/views/Home.vue */ "./resources/js/components/views/Home.vue");
window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js");

var app = new Vue({
  el: '#app',
  components: {
    App: _components_views_Home_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  render: function render(h) {
    return h(_components_views_Home_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }
});
